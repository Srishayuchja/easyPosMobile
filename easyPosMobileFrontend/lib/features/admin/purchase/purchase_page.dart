  ...
  List<ProductModel> _filtered(List<ProductModel> all) {
    ...
    return all
        .where((p) =>
            ...
            p.barcode.contains(_searchCtrl.text.trim()))
        .take(8)
        .toList();
  }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(applied
              ? 'Added $_qty units to ${_selected!.name}'
        ...
        body: SafeArea(
          child: Column(
            children: [
              AppHeader(
                  title: 'Add Stock',
                  subtitle: 'Add stock for a product',
                              ...
                              onTap: () => Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (_) => AddProductPage(
                                          prefillBarcode: _searchCtrl.text))),
